...
class RecommendationAdapter(
    private val callback: RecommendationAdapter.ItemClaimClickListener,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecommendationViewHolder {
        ...
        return RecommendationViewHolder(itemRowClaimsBinding)
    }
    ...
    class RecommendationViewHolder(val binding: ItemRowClaimsBinding) :
